...
def search():
    ...
    for case_index, case in enumerate(event_log):
        ...
        try:
            ...
            with open('F:\Thesis\data\c19_astar_tue\c19_astar_tue_cache.csv', 'a') as f_object:
    ...
    df = pd.read_csv('F:\Thesis\data\c19_astar_tue\c19_astar_tue_cache.csv')
    total = df.sum()
    ...
    df3.to_csv('F:\Thesis\data\c19_astar_tue\c19_astar_tue_cache.csv', index=False)
