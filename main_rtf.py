...
def search():
    ...
    df.to_csv('F:\Thesis\data\RTF_astar_tue\RTF_astar_tue_new2.csv', sep=',', index=False)
    ...
    for case_index, case in enumerate(event_log):
        ...
        try:
            ...
            with open('F:\Thesis\data\RTF_astar_tue\RTF_astar_tue_new2.csv', 'a') as f_object:
    ...
    df = pd.read_csv('F:\Thesis\data\RTF_astar_tue\RTF_astar_tue_new2.csv')
    total = df.sum()
    ...
    df3.to_csv('F:\Thesis\data\RTF_astar_tue\RTF_astar_tue_new2.csv', index=False)
